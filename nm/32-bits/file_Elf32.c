/*
** file_Elf32.c for file_Elf32 in /home/nasrat_v/Dev/rendu/tek2/Systeme-Unix/Memoire/PSU_2016_nmobjdump/32-bits
** 
** Made by Valentin Nasraty
** Login   <valentin.nasraty@epitech.eu>
** 
** Started on  Mon Feb 20 05:07:44 2017 Valentin Nasraty
** Last update Thu Feb 23 23:32:18 2017 Valentin Nasraty
*/
...
int		_32_file_is_empty(t_elf32 *elf)
{
  ...
  if ((stat(elf->file.filepath, &st) == 0) && (st.st_size > 0))
    return (0);
  return (-1);
}
